...
#define PROFILE_BEGIN_SESSION(name, filepath) ::mv::Instrumentor::Get().BeginSession(name, filepath)
#define PROFILE_END_SESSION() ::mv::Instrumentor::Get().EndSession()
#define PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::mv::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
																					 ::mv::InstrumentationTimer timer##line(fixedName##line.Data)
